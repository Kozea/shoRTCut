...
(function() {
  var DiskFileReceiver, FileHelper, FileReceiver, FileSender, MemoryFileReceiver, ShoRTCutHelpers, chunk_size, getFileReceiver, rfs, _ref, _ref1,
  ...
  DiskFileReceiver = (function(_super) {
    ...
    function DiskFileReceiver(name, size, type, ready, end, progress) {
      var _this = this;
      this.name = name;
      this.size = size;
      this.type = type;
      ...
      this.flushing = false;
      this.callbacks = [];
      rfs(TEMPORARY, size, function(fs) {
        var get_file;
        get_file = function() {
  ...
  MemoryFileReceiver = (function(_super) {
    ...
    function MemoryFileReceiver() {
      _ref1 = MemoryFileReceiver.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  getFileReceiver = function() {
    if (rfs) {
      ...
      return ShoRTCutHelpers.prototype.MemFileReceiver;
    }
  };
